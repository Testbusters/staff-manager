  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 p-4">
      <div className="w-full max-w-sm text-center">
        <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gray-800 mb-6">
        ...
        <h1 className="text-lg font-semibold text-gray-100 mb-2">Pagina non trovata</h1>
