...
FR-CORSI-13: The Responsabile Cittadino shall be able to assign a valutazione (numeric 1–10) per collaboratore×corso on the /corsi/valutazioni page. The score is stored on all assegnazioni for that collaboratore in that corso.
