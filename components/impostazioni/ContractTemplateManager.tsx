...
const RICEVUTA_MARKERS = [
  ...
  { key: '{codice_fiscale}',                      desc: 'Codice fiscale' },
  { key: '{data_nascita}',                        desc: 'Data di nascita' },
  { key: '{totale_lordo_liquidato}',              desc: 'Totale lordo — solo numero (es. 422,75)' },
  { key: '{totale_ritenuta_acconto_liquidato}',   desc: 'Ritenuta d\'acconto — solo numero (es. 84,55)' },
  { key: '{totale_netto_liquidato}',              desc: 'Netto liquidato — solo numero (es. 338,20)' },
  { key: '{data_corrente}',                       desc: 'Data di oggi (DD/MM/AAAA)' },
  { key: '{firma}',                               desc: 'Firma collaboratore (PNG)' },
];
