...
supabase/migrations/  076 migrations applied in sequence (see docs/migrations-log.md)
lib/schemas/      15 shared Zod schemas (form + API validation)
__tests__/        523 Vitest tests (unit + API schema validation)
