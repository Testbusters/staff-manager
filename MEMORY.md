...
|------|-------------|--------|
| C | Guided review of `docs/requirements.md`: section-by-section comparison, user approval per change | 🔄 in progress — Blocks 1–13 done, next blocks to define |
| D | Rebuild `docs/implementation-checklist.md` based on updated `requirements.md` | 🔄 in progress — Blocks 1–13 ✅, next blocks to plan |
